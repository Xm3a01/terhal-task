...
@section('content')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">جدول الصلاحيات</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_3">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="ar_coName" data-align="center" data-sortable="true">الصلاحيه </th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">إضافة صلاحيه جديده</h4>
                </div>
                                    ...
                                    <form class="form-horizontal" id="level-form" role="form" method="POST"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="e.g posts"
                                                        name="prefix">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-2">
                                                ...
                                                {{-- <h3>اختر تصنيفا</h3> --}}
                                                <label class="col-md-3 control-label">اختار اللاحقه</label>

                                                <div class="col-md-6">
                                                    {{-- @foreach ($groups as $group) --}}
                                                    {{-- <div class="col-md-6"> --}}
                                                    <div class="form-group">
                                                        <input type="checkbox" name="sufix[]" value="create"> Create
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="checkbox" name="sufix[]" value="update"> Update
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="checkbox" name="sufix[]" value="show"> Show
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="checkbox" name="sufix[]" value="delete"> Delete
                                                    </div>
                                                    {{-- </div> --}}
