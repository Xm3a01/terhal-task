...
<div class="page-head">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">  تعديل الحساب  </span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-social-dribbble font-green hide"></i>
                          <span class="caption-subject font-dark bold uppercase"> تعديل الحساب </span>
                    </div>
                 </div> 
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" method="POST" action="{{route('account.update',Auth::user()->id)}}">
                @csrf
                @method('PUT')
                <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="password" class="form-control" placeholder="كلمة المرور الجديده" name="password">
                                            </div>
                                    </div> 
